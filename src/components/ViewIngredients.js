...
export const ViewIngredients = () => {
  ...
  return (<>
    <TopNav />
    {/*Header Section*/}
    <header className="masthead_Pancakes">
      <div className="container h-100">
        <div className="col-12 text-center">
          <p className="text-center text-light" style={{ position: "relative", top: "140px", fontSize: "23px", }}>Quick & Easy Recipes</p>
          <h1 className="text-center text-light" style={{ position: "relative", top: "25vh", fontSize: "55px", }}>Pancakes Recipes</h1>
          <p className="text-center text-light" style={{ position: "relative", top: "35vh", fontSize: "25px", }}>You can't go wrong with a panckes. It's a sure way to get the kids clearing their plates, and a winning dinner for two. We've got everything from the classics to fresh new inspiration when you feel like trying something new.</p>
        </div>
      </div>
    </header>

    <h4 className="text-start text-dark my-5" style={{ position: "relative", left: "15%", top: "40px", fontWeight: "600", fontSize: "60px", }}>Panckes</h4>
